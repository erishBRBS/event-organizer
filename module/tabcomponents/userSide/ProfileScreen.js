      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          ...
          <Image
            ...
            source={require('../../../assets/screen-img/concert.jpeg')}
          />
        ...
        <View style={styles.btnContainer}>
          ...
          <TouchableOpacity style={styles.touchStyle}>
            <View style={styles.btnStyle} onPress ={() => navigation.navigate('Login')}>
        ...
        <Modal
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              <Text style={{ fontWeight: 'bold', marginBottom: 10 }}>Edit Profile Name</Text>
              <TextInput
                style={styles.input}
